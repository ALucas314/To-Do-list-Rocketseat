...
export function NewNoteCard({onNoteCreated}: NewNoteCardProps) {
  ...
  const [isReconrding, setIsRecording] = useState(false)
  ...
  function handleStartRecording() {
    ...
    if (!isSpeechRecognitionAPIAvailable) {
      alert('Infelizmente seu navegador nãon suporta a API de gravação!')
      return
    }
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 p-5 text-left gap-3 hover:ring-2 outline-none hover:ring-slate-600 focus:ring-2 focus:ring-lime-400">
